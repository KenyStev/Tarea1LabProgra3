...
int main( int argc, char* args[] )
{
    ...
    SDL_QueryTexture(character, NULL, NULL, &rect_character.w, &rect_character.h);
    ...
    while(true)
    {
        while(SDL_PollEvent(&Event))
        {
            ...
            if(Event.type == SDL_KEYDOWN)
            {
                ...
                {
                    case SDLK_w: rect_character.y--; break;
                    case SDLK_s: rect_character.y++; break;
                    case SDLK_a: rect_character.x--; break;
                    case SDLK_d: rect_character.x++; break;
                }
            }
        }
